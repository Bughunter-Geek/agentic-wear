/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2eef31d9bb2e7cf3ce08dfe4c881197a)
// Runtime types generated with workerd@1.20260826.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	PAIR_SOURCE_RATE_LIMITER: RateLimit;
	PAIR_LOCATION_RATE_LIMITER: RateLimit;
	PAIR_CODE_TTL_SECONDS: "600";
	INBOX_TTL_SECONDS: "86400";
	MAX_PENDING_PAIRS: "500";
	MAX_PAIR_ATTEMPTS_PER_MINUTE: "120";
	PAIR_RELAY: DurableObjectNamespace<import("./src/index").PairRelay>;
	PAIR_ADMISSION: DurableObjectNamespace<import("./src/index").PairAdmission>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PairRelay" | "PairAdmission";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAIR_CODE_TTL_SECONDS" | "INBOX_TTL_SECONDS" | "MAX_PENDING_PAIRS" | "MAX_PAIR_ATTEMPTS_PER_MINUTE">> {}
}
